...
class AotModel:
    ...
    aliases: tuple[str, ...] = ()
    # Further register.py keys for the exact same checkpoint geometry (text-only /
    # GGUF config variants). Universal JIT-backed registry entries must not be claimed
    # here merely to make a registry-wide assertion pass.
